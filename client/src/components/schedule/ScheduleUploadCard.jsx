  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-8 flex flex-col items-center justify-center min-h-[300px]">
        <h3 className="font-bold text-xl text-zinc-100 mb-2">Import Project Schedule</h3>
        <p className="text-sm text-zinc-400 mb-6 text-center max-w-sm">Upload your schedule data to run AI risk prediction and dependency graph analysis.</p>
        ...
        {!file ? (
          ...
          >
            ...
            <p className="text-lg font-medium text-zinc-200 mb-2">Drag & drop your file here</p>
            <p className="text-sm text-zinc-400 mb-4">or <span className="text-sky-500 font-semibold hover:underline">browse files</span></p>
            
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-400 bg-zinc-800/50 px-4 py-2 rounded-lg">
              <span>SUPPORTED:</span>
              <span className="text-zinc-400">ALL FORMATS</span>
            </div>
          </div>
        ) : (
