    ...
    <div className="card p-10 bg-[#2a2a2a]/60 backdrop-blur-xl border border-white/50 relative overflow-hidden">
      ...
      <div className="flex items-center gap-5 mb-10">
        <motion.div 
          ...
          className="w-12 h-12 border-4 border-zinc-800 border-t-amber-500 rounded-full shadow-lg"
        />
        <div>
          <h3 className="text-2xl font-bold text-zinc-100 tracking-tight">AI Schedule Intelligence Engine</h3>
          <p className="text-sm font-medium text-zinc-400 mt-1">Simulating thousands of monte carlo project paths...</p>
        </div>
      </div>

      <div className="relative pl-6 border-l-2 border-zinc-800 space-y-8 max-w-2xl">
        {STEPS.map((step, idx) => {
          ...
          return (
            <div key={idx} className="relative">
              ...
              >
                ...
                {isActive && (
                  <motion.div 
                    ...
                    className="w-2 h-2 bg-blue-950/400 rounded-full"
                  />
                )}
              </div>
              ...
              <motion.div 
                ...
                className="pl-4"
              >
                <span className={`text-base font-semibold ${isCompleted ? "text-zinc-100" : isActive ? "text-blue-400" : "text-slate-400"}`}>
                  {step}
                </span>
