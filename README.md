...
- **Server**: FastAPI (Python), SQLite (via sqlite3/custom wrappers), Uvicorn.
...
- **Schedule Risk Analysis**: An AI agent running in the server evaluates tasks based on float days, predecessor risks, and procurement delays (tied to equipment NCRs) to calculate risk scores and delay probabilities. The agent leverages Claude to generate 3 actionable mitigation strategies for high-risk tasks.
